...
void location_pars(server *ss, vector<server> &tmp, std::ifstream &file, vector<string> str)
{
    loc tmp1;
    string stmp = str[1];
    string line;
...
void server_pars(vector<server> &tmp,std::ifstream &file, server *ss)
{
    vector<string> str;
    string line;
