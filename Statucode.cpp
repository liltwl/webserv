...
string Statucode::get_code(int code)
{
    {
            return ("HTTP/1.1 " + to_string(code) + " " + codes[to_string(code)]);
    }
}
void Statucode::set_error(vector<vector<string> > pages, int code, int size)
{
    {
        int i = 0;
...
string Statucode::renderpage(string filename,int code)
{
...
string Statucode::get_errorhtml(int code, string uploadfile)
{
    string page;
    if(this->error == 0)
    {
